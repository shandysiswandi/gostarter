...
func (_m *MockFetchStore) Fetch(ctx context.Context, filter map[string]string) ([]domain.Todo, error) {
	...
	var r0 []domain.Todo
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, map[string]string) ([]domain.Todo, error)); ok {
		return rf(ctx, filter)
	}
	if rf, ok := ret.Get(0).(func(context.Context, map[string]string) []domain.Todo); ok {
		r0 = rf(ctx, filter)
	} else {
		if ret.Get(0) != nil {
...
func (_c *MockFetchStore_Fetch_Call) Run(run func(ctx context.Context, filter map[string]string)) *MockFetchStore_Fetch_Call {
...
func (_c *MockFetchStore_Fetch_Call) RunAndReturn(run func(context.Context, map[string]string) ([]domain.Todo, error)) *MockFetchStore_Fetch_Call {
	_c.Call.Return(run)
	return _c
}
