...
func (_m *MockEmitter) AddListener(topic string) <-chan Event {
	ret := _m.Called(topic)
	...
	var r0 <-chan Event
	if rf, ok := ret.Get(0).(func(string) <-chan Event); ok {
		r0 = rf(topic)
	} else {
		if ret.Get(0) != nil {
...
func (_c *MockEmitter_AddListener_Call) Return(_a0 <-chan Event) *MockEmitter_AddListener_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockEmitter_AddListener_Call) RunAndReturn(run func(string) <-chan Event) *MockEmitter_AddListener_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockEmitter) RemoveListener(topic string, listeners ...<-chan Event) {
...
func (_c *MockEmitter_RemoveListener_Call) Run(run func(topic string, listeners ...<-chan Event)) *MockEmitter_RemoveListener_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]<-chan Event, len(args)-1)
		for i, a := range args[1:] {
			if a != nil {
				variadicArgs[i] = a.(<-chan Event)
			}
		}
		run(args[0].(string), variadicArgs...)
	})
...
func (_c *MockEmitter_RemoveListener_Call) RunAndReturn(run func(string, ...<-chan Event)) *MockEmitter_RemoveListener_Call {
	_c.Call.Return(run)
	return _c
}
