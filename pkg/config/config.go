...
type Config interface {
	...
	// the implementation should handle it accordingly (e.g., return a default value or an error).
	...
	// This is useful for binary data such as images or files.
	...
	// This is useful for list-based configurations.
	...
	// This is useful for key-value pair configurations.
