...
func TestJWAsymmetric_Generate(t *testing.T) {
	...
	tests := []struct {
		...
		want    string
		wantErr bool
		mockFn  func(a args) *JWTAsymmetric
	}{
		{
			name: "Success",
			args: args{c: &Claim{
			...
			wantErr: false,
			mockFn: func(a args) *JWTAsymmetric {
				j, _ := NewJWTAsymmetric("", "LS0tLS1CRUdJTiBQVUJMSUMgS0VZLS0tLS0KTUZ3d0RRWUpLb1pJaHZjTkFRRUJCUUFEU3dBd1NBSkJBS1B6MnovNlZ5RzFSTDMwSThteDlsTEhKMnlXakZkNAoydG1DT0ErMDVwem9HR1VvYWtlT1Y4YjJGeHIySTVldlhiNkNZcXpTQnNkQlFNTkRXd3VCVmUwQ0F3RUFBUT09Ci0tLS0tRU5EIFBVQkxJQyBLRVktLS0tLQ==")
