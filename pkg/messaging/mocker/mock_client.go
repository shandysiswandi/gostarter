...
func (_m *MockClient) BulkPublish(ctx context.Context, topic string, data []*messaging.Data) error {
...
//   - topic string
//   - data []*messaging.Data
func (_e *MockClient_Expecter) BulkPublish(ctx interface{}, topic interface{}, data interface{}) *MockClient_BulkPublish_Call {
	return &MockClient_BulkPublish_Call{Call: _e.mock.On("BulkPublish", ctx, topic, data)}
}

func (_c *MockClient_BulkPublish_Call) Run(run func(ctx context.Context, topic string, data []*messaging.Data)) *MockClient_BulkPublish_Call {
...
func (_c *MockClient_BulkPublish_Call) RunAndReturn(run func(context.Context, string, []*messaging.Data) error) *MockClient_BulkPublish_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockClient) Publish(ctx context.Context, topic string, data *messaging.Data) error {
	ret := _m.Called(ctx, topic, data)
...
//   - topic string
//   - data *messaging.Data
func (_e *MockClient_Expecter) Publish(ctx interface{}, topic interface{}, data interface{}) *MockClient_Publish_Call {
	return &MockClient_Publish_Call{Call: _e.mock.On("Publish", ctx, topic, data)}
}

func (_c *MockClient_Publish_Call) Run(run func(ctx context.Context, topic string, data *messaging.Data)) *MockClient_Publish_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(*messaging.Data))
	})
	return _c
...
func (_c *MockClient_Publish_Call) RunAndReturn(run func(context.Context, string, *messaging.Data) error) *MockClient_Publish_Call {
	_c.Call.Return(run)
	return _c
}

// Subscribe provides a mock function with given fields: ctx, topic, subscriptionID, handler
func (_m *MockClient) Subscribe(ctx context.Context, topic string, subscriptionID string, handler messaging.SubscriberFunc) error {
...
func (_c *MockClient_Subscribe_Call) Run(run func(ctx context.Context, topic string, subscriptionID string, handler messaging.SubscriberFunc)) *MockClient_Subscribe_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockClient_Subscribe_Call) RunAndReturn(run func(context.Context, string, string, messaging.SubscriberFunc) error) *MockClient_Subscribe_Call {
	_c.Call.Return(run)
	return _c
}
